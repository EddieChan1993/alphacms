 ...
 *
 * @unknown-tag TestService description for the unknown tag
 */
DOCCOMMENT;
        ...
        $docBlock = new DocBlock(
            ...
            [
                new DocBlock\Tags\Generic('unknown-tag', new Description('TestService description for the unknown tag'))
            ]
        );
...
aa *
aa * @unknown-tag TestService description for the unknown tag
aa */
DOCCOMMENT;
