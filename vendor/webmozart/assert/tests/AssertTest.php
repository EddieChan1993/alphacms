...
class AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('throws', array(function() { throw new LogicException('TestService'); }, 'LogicException'), true),
            array('throws', array(function() { throw new LogicException('TestService'); }, 'IllogicException'), false),
            array('throws', array(function() { throw new Exception('TestService'); }), true),
            array('throws', array(function() { trigger_error('TestService'); }, 'Throwable'), true, false, 70000),
            array('throws', array(function() { trigger_error('TestService'); }, 'Unthrowable'), false, false, 70000),
