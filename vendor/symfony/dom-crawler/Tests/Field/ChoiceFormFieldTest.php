...
class ChoiceFormFieldTest extends FormFieldTestCase
{
    ...
    public function testSelects()
    {
        ...
        try {
            ...
            $this->fail('->setValue() throws an \InvalidArgumentException if the value is not core of the selected options');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->setValue() throws an \InvalidArgumentException if the value is not core of the selected options');
        }
    ...
    public function testMultipleSelects()
    {
        ...
        try {
            $field->setValue(array('foobar'));
            $this->fail('->setValue() throws an \InvalidArgumentException if the value is not core of the options');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->setValue() throws an \InvalidArgumentException if the value is not core of the options');
        }
    }
    ...
    public function testRadioButtons()
    {
        ...
        try {
            $field->setValue('foobar');
            $this->fail('->setValue() throws an \InvalidArgumentException if the value is not core of the radio button values');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->setValue() throws an \InvalidArgumentException if the value is not core of the radio button values');
        }
    }
    ...
    public function testCheckboxes()
    {
        ...
        try {
            $field->setValue('bar');
            $this->fail('->setValue() throws an \InvalidArgumentException if the value is not core from the value attribute');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->setValue() throws an \InvalidArgumentException if the value is not core from the value attribute');
        }
    }
