        ...
        <html>
            ...
            <form id="form_2" action="" method="POST">
                ...
                <div>
                    ...
                    <div>
                        <select name="app_frontend_form_type_contact_form_type[contactType]" id="app_frontend_form_type_contact_form_type_contactType"><option selected="selected" value="">Please select subject</option><option id="1">TestService type</option></select>
                    </div>
                </div>
                <div>
