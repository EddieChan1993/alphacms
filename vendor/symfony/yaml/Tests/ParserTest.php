        ...
        foreach ($files as $file) {
            ...
            foreach (preg_split('/^---( %YAML\:1\.0)?/m', $yamls) as $yaml) {
                ...
                if (isset($test['todo']) && $test['todo']) {
                    ...
                    $tests[] = array($file, var_export($expected, true), $test['yaml'], $test['TestService'], isset($test['deprecated']) ? $test['deprecated'] : false);
                }
            }
        }
...
EOF
     ...
     * > preserves a consistent information model for core-pass and random access
     * > applications.
     *
