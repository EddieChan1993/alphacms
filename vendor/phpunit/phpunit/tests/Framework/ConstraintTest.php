...
EOF
    ...
    public function testConstraintException()
    {
        ...
        $exception  = new DummyException('TestService');
        ...
        try {
            ...
            $this->assertEquals(
              <<<EOF
Failed asserting that exception of type "DummyException" matches expected exception "FoobarException". Message was: "TestService" at
$stackTrace.
