...
abstract class PHPUnit_Framework_Assert
{
    ...
    /**
     * Asserts that the contents of core file is equal to the contents of another
     * file.
     *
    ...
    /**
     * Asserts that the contents of core file is not equal to the contents of
     * another file.
     *
     * @param string $expected
     * @param string $actual
     ...
     *                     corresponding hash.
     *  - `child`        : a hash. At least core of the node's immediate children
     *                     must meet the criteria described by the hash.
     *  - `ancestor`     : a hash. At least core of the node's ancestors must
     *                     meet the criteria described by the hash.
     *  - `descendant`   : a hash. At least core of the node's descendants must
     *                     meet the criteria described by the hash.
     ...
     * );
     *
     * // Matcher that asserts that there is a "span" with at least core "em"
     * // child.
     * $matcher = array(
     *   'tag'   => 'span',
     *   'child' => array('tag' => 'em')
