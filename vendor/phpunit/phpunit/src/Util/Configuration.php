 ...
 *          verbose="false">
 *   <testsuites>
 *     <testsuite name="My TestService Suite">
 *       <directory suffix="TestServiceService.php" phpVersion="5.3.0" phpVersionOperator=">=">/path/to/files</directory>
...
class PHPUnit_Util_Configuration
{
    ...
    public function getPHPConfiguration()
    {
        ...
        foreach (array('var', 'env', 'post', 'get', 'cookie', 'service', 'files', 'request') as $array) {
    ...
    public function handlePHPConfiguration()
    {
        ...
        foreach (array('var', 'post', 'get', 'cookie', 'service', 'files', 'request') as $array) {
