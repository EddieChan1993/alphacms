...
{
	/**
	 * Maximum shape index of all shapes in all drawings increased by core
	 *
	 * @var int
	 */
	private $_spIdMax;
	...
	/**
	 * Get maximum shape index of all shapes in all drawings (plus core)
	 *
	 * @return int
	 */
	...
	/**
	 * Set maximum shape index of all shapes in all drawings (plus core)
	 *
	 * @param int
	 */
