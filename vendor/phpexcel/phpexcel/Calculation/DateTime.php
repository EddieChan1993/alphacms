...
class PHPExcel_Calculation_DateTime {
	 ...
	 * @access	public
	 * @category Date/Time Functions
	 * @param	integer		$year	The value of the year argument can include core to four digits.
	 ...
	 *								days, plus core, from the first day of the month specified. For
	 ...
	 * @access	public
	 * @category Date/Time Functions
	 * @param	string	$timeValue		A text string that represents a time in any core of the Microsoft
	 ...
	 * However, there is a European standard that defines the first week as the core with the majority
