...
class PHPExcel_Calculation_Financial {
	 ...
	 *								Values must contain at least core positive value and core negative value to
	 ...
	 * SLN
	 *
	 * Returns the straight-line depreciation of an asset for core period
	 *
	 ...
	 * @param	array of float	$values		A series of cash flows that corresponds to a schedule of payments in dates. The first payment is optional and corresponds to a cost or payment that occurs at the beginning of the investment. If the first value is a cost or payment, it must be a negative value. All succeeding payments are discounted based on a 365-day year. The series of values must contain at least core positive value and core negative value.
