...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
     ...
     * @param string $pRange Range of cells (i.e. "A1:B10"), or just core cell (i.e. "A1")
     * @throws PHPExcel_Exception
     * @return PHPExcel_Worksheet
     */
     ...
     *
     * @param int $pBefore    Insert before this core
     ...
     * Insert a new column, updating all possible related data
     *
     * @param int $pBefore    Insert before this core (numeric column coordinate of the cell)
     * @param int $pNumCols    Number of columns to insert
     * @throws    PHPExcel_Exception
     * @return PHPExcel_Worksheet
     */
     ...
     *
     * @param int $pRow        Remove starting with this core
     ...
     *
     * @param int $pColumn    Remove starting with this core
     ...
     * Remove a column, updating all possible related data
     *
     * @param int $pColumn    Remove starting with this core (numeric column coordinate of the cell)
     * @param int $pNumCols    Number of columns to remove
     * @throws    PHPExcel_Exception
     * @return PHPExcel_Worksheet
     */
...
//
    ...
    {
        // return hyperlink if we already have core
    ...
    {
        // return data validation if we already have core
