<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"E:\alphaCMS/app/admin\view\test2\home_page.html";i:1516688368;s:46:"E:\alphaCMS\app\admin\view\Public\content.html";i:1516067394;s:46:"E:\alphaCMS\app\admin\view\Public\head_in.html";i:1516067394;s:44:"E:\alphaCMS\app\admin\view\Public\alert.html";i:1516683724;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                    <div class="tab-pane active" id="tab-first">
                        <table class="table table-hover">
                            ...
                            <tr class="del_tr">
                                ...
                                <td>
                                    <a title="<?php echo $v['id']; ?>【编辑】" data-url="<?php echo url('admin/Test2/editPage',['id'=>$v['id']]); ?>" onclick="edit_row(this)"  class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                    <button data-url="<?php echo url('admin/Test2/delThink',['id'=>$v['id']]); ?>" onClick="delete_row(this);" class="btn btn-danger btn-rounded btn-sm" ><span class="fa fa-trash-o"></span></button>
                                </td>
                            </tr>
                    ...
                    <div class="tab-pane" id="tab-second">
                        <form id="add_form"  method="post" action="<?php echo url('admin/Test2/addThink'); ?>" class="form-horizontal">
