<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"C:\code_edd\201801\alphaCMS/app/admin\view\core\setting\plugins_home.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\content.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\head_in.html";i:1517109412;s:60:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\alert.html";i:1517109412;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                    <div class="tab-pane active" id="tab-first">
                        ...
                        <div class="col-md-12">
                            <div class="widget widget-<?php echo $v['wid_color']; ?> widget-item-icon">
                                <div title="<?php echo $v['wid_name']; ?>【编辑】" data-url="<?php echo url('admin/core.Setting/edit_plugins_page',['wid_id'=>$v['wid_id']]); ?>" onclick="edit_row(this)"  class="widget-item-left">
                                    <span class="<?php echo $v['wid_icon']; ?>"></span>
                                </div>
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php echo $v['wid_name']; ?>|<?php echo $v['wid_key']; ?></div>
                                    <?php $_5a6d412a99863=get_param_arr($v['wid_params']); if(is_array($_5a6d412a99863) || $_5a6d412a99863 instanceof \think\Collection || $_5a6d412a99863 instanceof \think\Paginator): if( count($_5a6d412a99863)==0 ) : echo "" ;else: foreach($_5a6d412a99863 as $key=>$k): ?>
                                    <div class="widget-subtitle"><?php echo $k; ?></div>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                                <div class="widget-controls">
                                    <a href="javascript:void();" data-url="<?php echo url('admin/core.Setting/del_plugins_think',['wid_id'=>$v['wid_id']]); ?>" onclick="del_wid(this)" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="删除模块"><span class="fa fa-times"></span></a>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="tab-pane" id="tab-second">
                        <form id="add_form" action="<?php echo url('admin/core.Setting/add_plugins_think'); ?>" method="post" class="form-horizontal">
