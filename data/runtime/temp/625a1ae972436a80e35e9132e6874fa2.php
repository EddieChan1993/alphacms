                        ...
                        <div class="col-md-12">
                            <div class="widget widget-<?php echo $v['wid_color']; ?> widget-item-icon">
                                ...
                                <div class="widget-data">
                                    ...
                                    <?php $_5a6ebe07b7acc=get_param_arr($v['wid_params']); if(is_array($_5a6ebe07b7acc) || $_5a6ebe07b7acc instanceof \think\Collection || $_5a6ebe07b7acc instanceof \think\Paginator): if( count($_5a6ebe07b7acc)==0 ) : echo "" ;else: foreach($_5a6ebe07b7acc as $key=>$k): ?>
