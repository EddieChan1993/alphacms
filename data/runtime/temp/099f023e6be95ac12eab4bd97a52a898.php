<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"E:\alphaCMS/app/admin\view\core\posts\edit_page_posts.html";i:1516682462;s:46:"E:\alphaCMS/app/admin\view\Public\head_in.html";i:1516067394;s:44:"E:\alphaCMS/app/admin\view\Public\alert.html";i:1516683724;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="panel panel-default">
    <form id="edit_form" action="<?php echo url('admin/core.Posts/edit_think_posts'); ?>" method="post" class="form-horizontal">
                            ...
                            <div class="gallery">
                                <a class="gallery-item" href="javascript:void('')" title="Space picture 2" data-gallery>
                                    <div style="width: 200px;height: 80px" class="image">
                                        <input name="smeta[thumb]" value="<?php echo getAttr($smeta,'thumb'); ?>" hidden type="text"
                                               id="inp">
                                        <img src="<?php echo is_img(getAttr($smeta,'thumb')); ?>" alt="Space picture 2"/>
                                        <ul class="gallery-item-controls">
                                            <li onclick="upload_single('inp','posts')"><i
                                                    class="fa fa-cloud-upload"></i></li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <select multiple name="smeta[term_relation][]" class="form-control select">
                                ...
                                <option <?php echo post_term($id,$v['term_id']); ?> value="<?php echo $v['term_id']; ?>"><?php echo $v['lefthtml']; ?><?php echo $v['name']; ?>
                                </option>
