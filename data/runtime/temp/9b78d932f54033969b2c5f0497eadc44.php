<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"C:\code_edd\201801\alphaCMS/app/admin\view\core\menu\home_page.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\content.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\head_in.html";i:1517109412;s:60:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\alert.html";i:1517109412;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                    <div class="tab-pane <?php echo !empty($menuChild)?$menuChild:'active'; ?>" id="tab-first">
                        <table  class="demo1 table datatable table-hover">
                            ...
                            <tr class="del_tr">
                                ...
                                <td>
                                    <a href="<?php echo url('admin/core.Menu/home_page',['menu_id'=>$v['id']]); ?>" class="btn btn-primary btn-rounded btn-sm"><span class="fa fa-plus"></span></a>
                                    <a title="<?php echo $v['name']; ?>【编辑】" data-url="<?php echo url('admin/core.Menu/edit_page',['menu_id'=>$v['id']]); ?>" onclick="edit_row(this)" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                    <button onClick="delete_row(this);" data-url="<?php echo url('admin/core.Menu/del_think',['id'=>$v['id']]); ?>" class="btn btn-danger btn-rounded btn-sm" ><span class="fa fa-trash-o"></span></button>
                                </td>
                            </tr>
                    ...
                    <div class="tab-pane <?php if(!empty($menuChild)) echo 'active'; ?>" id="tab-second">
                        <form id="add_form" action="<?php echo url('admin/core.Menu/add_think'); ?>" method="post" class="form-horizontal">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-3">
                                                ...
                                                <span class="help-block">用于多级控制器（选填）:shop.XXX</span>
                                            </div>
                                            <div class="col-md-3">
