<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"C:\code_edd\201801\alphaCMS/app/admin\view\core\dblist\home_page.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\content.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\head_in.html";i:1517109412;s:60:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\alert.html";i:1517109412;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="row animated fadeIn">
    <div class="row">
        <div class="col-md-7">
            <form id="export_more" method="post" action="<?php echo url('admin/core.Dblist/export_more'); ?>">
                ...
                <div class="panel-body tab-content">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-url="<?php echo url('admin/core.Dblist/export_one',['table_name'=>$v['name']]); ?>" onclick="copy_sql(this)" class="btn btn-warning btn-xs">备份</a>
                                </td>
                            </tr>
                ...
                <div class="panel-body tab-content">
                        <table class="table table-hover">
                            ...
                            <tr class="del_tr">
                                ...
                                <td>
                                    <a title="下载该sql文件" href="<?php echo url('admin/core.Dblist/download',['fileName'=>$v['filename']]); ?>"  class="btn btn-default btn-rounded btn-sm" ><span class="fa fa-cloud-download"></span></a>
                                    <button title="执行该sql文件" data-url="<?php echo url('admin/core.Dblist/restore',['fileName'=>$v['filename']]); ?>" onClick="copy_sql(this);" class="btn btn-info btn-rounded btn-sm" ><span class="fa fa-retweet"></span></button>
                                    <button title="删除该sql文件" data-url="<?php echo url('admin/core.Dblist/del',['fileName'=>$v['filename']]); ?>" onClick="delete_row(this);" class="btn btn-danger btn-rounded btn-sm" ><span class="fa fa-trash-o"></span></button>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
