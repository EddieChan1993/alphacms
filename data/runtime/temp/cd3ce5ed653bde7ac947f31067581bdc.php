<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"E:\alphaCMS/app/admin\view\core\posts\home_page_term.html";i:1516682494;s:46:"E:\alphaCMS/app/admin\view\Public\content.html";i:1516067394;s:46:"E:\alphaCMS/app/admin\view\Public\head_in.html";i:1516067394;s:44:"E:\alphaCMS/app/admin\view\Public\alert.html";i:1516683724;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                    <div class="tab-pane active" id="tab-first">
                        <table class="table table-hover">
                            ...
                            <tr class="del_tr">
                                ...
                                <td>
                                    <a title="<?php echo $v['name']; ?>【编辑】" data-url="<?php echo url('admin/core.Posts/edit_page_term',['term_id'=>$v['term_id']]); ?>" onclick="edit_row(this)"  class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                    <button data-url="<?php echo url('admin/core.Posts/del_think_term',['term_id'=>$v['term_id']]); ?>" onClick="delete_row(this);" class="btn btn-danger btn-rounded btn-sm" ><span class="fa fa-trash-o"></span></button>
                                </td>
                            </tr>
                    ...
                    <div class="tab-pane" id="tab-second">
                        <form id="add_form" action="<?php echo url('admin/core.Posts/add_think_term'); ?>" method="post" class="form-horizontal">
