<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:43:"E:\alphaCMS/app/admin\view\Public\base.html";i:1516067394;s:47:"E:\alphaCMS\app\admin\view\Public\head_out.html";i:1516067394;s:44:"E:\alphaCMS\app\admin\view\Public\alert.html";i:1516683724;s:46:"E:\alphaCMS\app\admin\view\Public\sidebar.html";i:1516701481;s:42:"E:\alphaCMS\app\admin\view\Public\nav.html";i:1516683298;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!-- META SECTION -->
    ...
    <link rel="icon" href="<?php echo get_options('site_logo'); ?>/data/upload/admin/common/logo.png" type="image/x-icon" />
<!-- END META SECTION -->
<!-- CSS INCLUDE -->
<link rel="stylesheet" type="text/css" id="theme" href="/public/admin/alpha/css/theme-default.css"/>
...
<script src="/public/admin/controller/silder.js"></script>
<!--前台框架自带的弹出层-->
...
<script type="text/javascript">
    ...
    <!-- MESSAGES -->
    <li class="xn-icon-button pull-right">
        <a href="#" title="<?php echo $self['user_login']; ?>【编辑】" data-url="<?php echo url('admin/core.Admin/edit_self_page',['id'=>$self['id']]); ?>" onclick="edit_row(this)"><span class="fa fa-user"></span></a>
...
<!-- START PRELOADS -->
<!--<audio id="audio-alert" src="/public/admin/alpha/audio/alert.mp3" preload="auto"></audio>-->
<!--<audio id="audio-fail" src="/public/admin/alpha/audio/fail.mp3" preload="auto"></audio>-->
<!-- END PRELOADS -->
