<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"E:\alphaCMS/app/admin\view\core\upload\upload_sigle.html";i:1516683330;s:46:"E:\alphaCMS\app\admin\view\Public\head_in.html";i:1516067394;s:44:"E:\alphaCMS\app\admin\view\Public\alert.html";i:1516683724;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="m_tip">
    ...
    <!-- styles -->
    <link href="/public/admin/alpha/plugins/edd-upload-sdk/src/jquery.fileuploader.css" media="all" rel="stylesheet">
    <link href="/public/admin/alpha/plugins/edd-upload-sdk/examples/single_file/css/jquery.fileuploader-theme-thumbnails.css" media="all" rel="stylesheet">
    <!-- js -->
    <script src="/public/admin/alpha/plugins/edd-upload-sdk/src/jquery.fileuploader.min.js" type="text/javascript"></script>
    <script src="/public/admin/alpha/plugins/edd-upload-sdk/examples/single_file/js/custom.js" type="text/javascript"></script>
    <style>
        body {
...
<body>
<form action="<?php echo url('admin/core.upload/upload_sigle'); ?>" method="post" enctype="multipart/form-res">
...
<script src="/public/admin/alpha/plugins/edd-upload-sdk/ajaxForm.js" crossorigin="anonymous"></script>
    ...
    function showResponse2(res) {
        ...
        if (res.code) {
            m_success('图片上传成功^_^', {
                ...
                if(type=='file') {
                    //如果是文档
                    src = '/data/upload/admin/common/file.png';
                }else{
                    //如果是图片
                    src = res.msg;
                }
