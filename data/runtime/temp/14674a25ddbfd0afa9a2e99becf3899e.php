<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"C:\code_edd\201801\alphaCMS/app/admin\view\core\setting\home_page.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\content.html";i:1517109412;s:62:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\head_in.html";i:1517109412;s:60:"C:\code_edd\201801\alphaCMS/app/admin\view\Public\alert.html";i:1517109412;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="panel panel-default tabs">
                ...
                <div class="panel-body tab-content">
                    <div class="tab-pane active" id="tab-first">
                        <form id="add_form1" action="<?php echo url('admin/core.Setting/save_sites'); ?>" method="post" class="form-horizontal">
                    ...
                    <div class="tab-pane" id="tab-second">
                        <form id="add_form2" action="<?php echo url('admin/core.Setting/save_seo'); ?>" method="post" class="form-horizontal">
                            <div class="panel-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
