<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:51:"E:\alphaCMS/app/admin\view\core\menu\edit_page.html";i:1516681545;s:46:"E:\alphaCMS/app/admin\view\Public\head_in.html";i:1516067394;s:44:"E:\alphaCMS/app/admin\view\Public\alert.html";i:1516683724;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="panel panel-default">
    <form id="edit_form" method="post" action="<?php echo url('admin/core.Menu/edit_think'); ?>" class="form-horizontal" role="form">
            ...
            <div class="row">
                <div class="col-xs-11">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-3">
                            <input name="extra_controller" type="text" value="<?php echo $controller; ?>" class="form-control"/>
