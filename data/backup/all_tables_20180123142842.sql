...
CREATE TABLE `edd_imgs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='图片管理';
...
) ENGINE=InnoDB AUTO_INCREMENT=348 DEFAULT CHARSET=utf8 COMMENT='后台菜单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='全站配置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Portal文章表';
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='角色用户关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类对应表';
...
CREATE TABLE `edd_terms` (
  ...
  PRIMARY KEY (`term_id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类表';
INSERT INTO `edd_terms` VALUES 
('24','首页','','文章','sdfsdf213','0','0','0','','','','news','content','0','1');
DROP TABLE IF EXISTS edd_test;
CREATE TABLE `edd_test` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0-one 1-two 2-three',
  `c_time` varchar(255) NOT NULL DEFAULT '' COMMENT '创建时间',
  `u_time` varchar(255) NOT NULL DEFAULT '' COMMENT '编辑时间',
...
('1','admin','http://p2otxz81j.bkt.clouddn.com/f100733b1b9c3d652d3202ac2dbc91fc.jpg','f354bc916f4979959bb4c274e8e92976','aZKZBygJtL','admin','dc_wen663@163.com','127.0.0.1','1516685801','1516686050','1489155324','1','','95');
