...
class Posts extends Base
{
    ...
    function home_page_posts()
    {
        ...
        $get['condtion']['post_type'] = 1;
        $get['unshow'] = 'post_content';
        $postsMap = $this->getDataList($get);

        $termsList = Db::name('terms')->select();//内容分类列表
        $termsList = menu_left($termsList, 'term_id', 'path');
        $postsMap['termsList'] = $termsList;
        return view('core/posts/home_page_posts', $postsMap);
    }
    ...
    function edit_page_posts()
    {
        ...
        return view('core/posts/edit_page_posts', $postsMap);
    }
    ...
    function home_page_term()
    {
        ...
        return view('core/posts/home_page_term', $termMap);
    }
    ...
    function edit_page_term()
    {
        ...
        return view('core/posts/edit_page_term', $termMap);
    }
